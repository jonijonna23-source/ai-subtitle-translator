...
Contextual Adaptation: Adapt the language level based on the context. Use clean, natural daily conversation for casual scenes, and formal language only when the on-screen context demands it (e.g., news, legal, or formal speeches). For dramatic narrations or cinematic monologues, use a powerful yet natural storytelling tone — avoid stiff or overly literal phrasing that sounds unnatural when spoken aloud. For cinematic narrations, avoid passive constructions that sound unnatural in the target language. Restructure the sentence if needed to sound more natural and dramatic.
